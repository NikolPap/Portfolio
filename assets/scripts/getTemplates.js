...
document.getElementById("text-center").innerHTML = reviewsData[indexCenter].text;
...
document.getElementById("text-right").innerHTML = reviewsData[indexRight].text;
