  ...
  return /*html*/ `
    <nav class="navbar">
      <div class="navigation">
        <!-- Desktop Left Section (Links + Lang) -->
    ...
    <!-- Hero Content (Υπόλοιπο Hero section) -->
    <div class="hero-content">
      <p class="subtitle">Frontend Developer</p>
      <h1>Nikoleta Papalazarou</h1>
      <div class="cta-buttons">
        <a href="#projects" class="btn btn-outline btn-marquee"><span>Check my work</span></a>
        <a href="#contact" class="btn btn-outline btn-marquee"><span>Contact me</span></a>
      </div>
    </div>
